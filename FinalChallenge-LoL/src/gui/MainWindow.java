...
public class MainWindow extends JFrame implements ActionListener, MouseListener {
	...
	/**
	 * Deletes a user from management tab in administration view.
	...
	/**
	 * Sends the new administrator profile created in the admin view.
	 * @throws PersonalizedException
	 */
	...
	/**
	 * Getter for the Main window user instance.
	 * @return user is the user information.
	 */
	public User getUser() {
		return user;
	}
	...
	/**
	 * Setter for the main window user.
	 * @param user is where the user information is stored.
	 */
	...
	/**
	 * When the "eye" icon is pressed in management tab, the password entered will be shown.
	 */
	@Override
	...
	/**
	 * When the "eye" icon is released in management tab, the password hides again.
	 */
	@Override
